...
* Add dtk-client to PATH, <tt>e.g. export PATH=$PATH:/home/user/dtk-client/bin</tt>

= Configuration Setup

* Create file <tt>etc/dtk/client.conf</tt> there you define server host
