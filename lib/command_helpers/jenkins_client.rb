...
module DTK; module Client
  class JenkinsClient
    require File.expand_path('jenkins_client/generate_config', File.dirname(__FILE__))
    include GenerateConfigMixin
    ...
    def self.createJenkins_project(module_id,module_name,repo_url,branch)
      ...
      config_xml_contents = generate_config(repo_url,module_id,branch)
   ...
   private
    ...
    def self.configure_connection(username,password,jenkins_server_url)
