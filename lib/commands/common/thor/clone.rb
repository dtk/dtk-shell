...
module DTK::Client
  module CloneMixin
      ...
      if response.ok?
        ...
        unless internal_trigger
          if Console.confirmation_prompt("Would you like to edit cloned module now?")
            context_params_for_module = create_context_for_module(module_name, module_type)
    ...
    def create_context_for_module(module_name, module_type)
      ...
      context_params_for_module.add_context_to_params(module_name, module_type.to_s.gsub!(/\_/,'-').to_sym, module_name)
